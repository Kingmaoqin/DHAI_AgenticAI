...
from log.fwa_logger import getLogger
            ...
            try:
                ...
                if 0:
                    for task in tasks_data:
                        if task['input_data'][0] == "Cam003-Disposal0.mp4" or \
                            task['input_data'][0] == "WH_Spares_Distribution_Front1080p_2023_09_27_8AM_55_25_H_00h01m00s_00h01m10s.mp4":
                            print(task['id'])
                            print(task['input_data'][0])
                            print("#################################")
                        if task['input_data'] == "Cam003-Disposal0.mp4" or \
                            task['input_data'] == "WH_Spares_Distribution_Front1080p_2023_09_27_8AM_55_25_H_00h01m00s_00h01m10s.mp4":
                            print(task['id'])
                            print(task['input_data'])
                            print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
                        if task['input_data'] == 'WH_Products_Dispatch_2023_09_27_8AM_13_00_H_02_02.jpg':
                            print(task['id'])
                            print(task['input_data'])
                            print("#################################")
                        if task['input_data'][0] == 'WH_Products_Dispatch_2023_09_27_8AM_13_00_H_02_02.jpg':
                            print(task['id'])
                            print(task['input_data'])
                            print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
